...
Refinery::Images.configure do |config|
  ...
  config.user_image_sizes = {:small=>"150x150>", :medium=>"480x640>", :large=>"1200x1200>"}
  ...
  config.dragonfly_secret = "e09d6ef5982e1607b1d65096766e2ca1a674dfb68db208af"
  # config.dragonfly_url_format = "/system/images/:job/:basename.:ext"
  # config.dragonfly_url_host = ""
  # config.datastore_root_path = "/projects/whynot/public/system/refinery/images"
